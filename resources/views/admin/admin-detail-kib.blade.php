    ...
    <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="p-6">
                    ...
                    <div class="bg-white rounded-lg border shadow-sm">
                        ...
                        <div class="bg-orange-300 p-3 rounded-b-lg">
                            ...
                            <div class="flex justify-center gap-2 mt-2">
                                ...
                                <form action="{{ route('admin.kib.destroy', $kib) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" 
            ...
            <div class="mt-6 p-4 bg-gray-50 rounded-lg">
                <form action="{{ route('admin.kib.upload', $kibType) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div class="space-y-2">
