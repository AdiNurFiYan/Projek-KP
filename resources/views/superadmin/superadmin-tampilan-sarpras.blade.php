...
<div class="bg-white shadow rounded-xl border border-gray-200">
    <form id="updateForm" 
          action="{{ route('super-admin.sekolah.update-detail-sarpras', ['sekolah' => $sekolah->id, 'detailSarpras' => $detailSarpras->id]) }}" 
          method="POST"
        ...
        const renderModal = () => {
            ...
            root.render(React.createElement(ConfirmationModal, {
                ...
                onConfirm: () => {
                    ...
                    fetch(`{{ route('super-admin.sekolah.delete-photo-sarpras', ['sekolah' => $sekolah->id, 'detailSarpras' => $detailSarpras->id]) }}`, {
                        method: 'POST',
                        headers: {
