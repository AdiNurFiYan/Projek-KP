                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <div class="flex border-b bg-white overflow-x-auto">
                        ...
                        <a href="{{ route('super-admin.sekolah.detail-data-sarpras', $sekolah) }}"
                            class="{{ Request::routeIs('super-admin.sekolah.detail-data-sarpras') ? 'border-b-2 border-yellow-400 bg-[#FFB930] text-black font-medium' : 'text-gray-600 hover:bg-yellow-50/50 hover:text-black' }} px-6 py-3 transition-all duration-200">
                            Detail Data Sarpras
                        </a>
                    </div>
