            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100">
                <div class="p-6">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
                        ...
                        <form action="{{ route('super-admin.sekolah.create', ['korwil' => $korwil, 'jenis' => request()->jenis]) }}" method="POST">
                            @csrf
                            <button type="submit" 
                                id="submitBtn"
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <div class="flex justify-center space-x-3">
                                            <a href="{{ route('super-admin.sekolah.detail', ['sekolah' => $sekolah, 'jenis' => request()->jenis]) }}" 
                                            ...
                                            <button type="button" 
                                                    onclick="showDeleteModal('{{ $sekolah->nama }}', '{{ route('super-admin.sekolah.destroy', $sekolah) }}')"
