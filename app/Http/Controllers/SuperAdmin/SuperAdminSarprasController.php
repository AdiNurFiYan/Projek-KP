...
class SuperAdminSarprasController extends Controller
{
    public function index(Korwil $korwil)
    {
        $sekolahs = $korwil->sekolahs()->paginate(10);
        return view('superadmin.superadmin-sekolah-sarpras', compact('korwil', 'sekolahs'));
    }
    ...
    public function show(Sekolah $sekolah)
    {
        try {
            ...
            return view('superadmin.superadmin-data-sarpras', compact('sekolah', 'sarpras'));
        } catch (\Exception $e) {
    ...
    public function update(Request $request, Sekolah $sekolah)
    {
        try {
            ...
            DB::commit();
            return redirect()
                ->route('super-admin.sekolah.data-sarpras', $sekolah)
