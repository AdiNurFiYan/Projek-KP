...
class SuperAdminLaporanAsetController extends Controller
{
    public function index(Sekolah $sekolah)
    {
        return view('superadmin.superadmin-laporan-aset', compact('sekolah'));
    }
    ...
    public function store(Request $request, Sekolah $sekolah)
    {
        try {
            ...
            if ($request->hasFile('laporan_asset')) {
                ...
                return redirect()
                    ->route('super-admin.sekolah.laporan-aset', $sekolah)
