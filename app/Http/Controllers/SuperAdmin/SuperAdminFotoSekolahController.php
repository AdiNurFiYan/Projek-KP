...
class SuperAdminFotoSekolahController extends Controller
{
    public function index(Sekolah $sekolah)
    {
        try {
            ...
            return view('superadmin.superadmin-foto-sekolah', compact('sekolah'));
        } catch (\Exception $e) {
    ...
    public function store(Request $request, Sekolah $sekolah)
    {
        try {
            ...
            return redirect()
                ->route('super-admin.sekolah.foto-sekolah', $sekolah)
