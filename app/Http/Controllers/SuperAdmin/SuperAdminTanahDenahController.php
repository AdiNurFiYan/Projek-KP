...
class SuperAdminTanahDenahController extends Controller
{
    /**
    ...
    {
        return view('superadmin.superadmin-tanah-dan-denah', compact('sekolah'));
    }
    ...
    public function update(Request $request, Sekolah $sekolah)
    {
        try {
            ...
            DB::commit();
            return redirect()
                ->route('super-admin.sekolah.tanah-denah', $sekolah)
