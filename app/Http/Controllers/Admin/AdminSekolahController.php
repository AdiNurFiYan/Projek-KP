...
class AdminSekolahController extends Controller
{
   public function tingkatan()
   {
       ...
       return view('admin.admin-tingkatan-sekolah', compact('korwils'));
   }
   ...
   public function index(Korwil $korwil)
   {
       ...
       return view('admin.admin-data-sekolah', compact('korwil', 'sekolahs'));
   }
   ...
   public function create(Korwil $korwil)
   {
       try {
           ...
           return redirect()
               ->route('admin.sekolah.detail', ['sekolah' => $sekolah, 'jenis' => request()->jenis])
   ...
   public function destroy(Sekolah $sekolah)
   {
       try {
           ...
           return redirect()
               ->route('admin.sekolah.sarpras', ['korwil' => $korwil])
   ...
   public function datasekolah()
   {
       try {
           ...
           return view('admin.admin-data-sekolah', ['korwils' => $korwils]);
   ...
   public function show(Sekolah $sekolah)
   {
       try {
           ...
           return view('admin.admin-tampilan-sarpras', [
               'sekolah' => $sekolah,
