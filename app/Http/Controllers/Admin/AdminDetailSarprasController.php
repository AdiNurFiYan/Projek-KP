...
class AdminDetailSarprasController extends Controller
{
    public function show(Sekolah $sekolah)
    {
        try {
            ...
            return view('admin.admin-detail-sarpras', [
                'sekolah' => $sekolah
            ]);
    ...
    public function showSarpras(Sekolah $sekolah)
    {
        try {
            ...
            return view('admin.admin-detail-data-sarpras', [
                'sekolah' => $sekolah,
    ...
    public function deletePhoto(Request $request, Sekolah $sekolah, DetailSarpras $detailSarpras)
    {
        try {
            ...
            // Simpan nama file foto yang akan dihapus untuk logging
    ...
    public function store(Request $request, Sekolah $sekolah)
    {
        try {
            ...
            return redirect()
                ->route('admin.sekolah.detail-data-sarpras', $sekolah)
